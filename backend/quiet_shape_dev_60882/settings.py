"""
Django settings for quiet_shape_dev_60882 project.
...
ROOT_URLCONF = 'quiet_shape_dev_60882.urls'
...
WSGI_APPLICATION = 'quiet_shape_dev_60882.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_shape_dev_60882 API",
    "DESCRIPTION": "API documentation for quiet_shape_dev_60882 App",
    "VERSION": "v1",
}
